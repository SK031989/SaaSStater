        ...
        <div class="row g-4">
            <div class="col-lg-5 col-md-6">
                <h5 class="fw-bold mb-3 d-flex align-items-center gap-2">
                    <i class="bi {{ $biIcon }} text-danger"></i> {{ config('settings.project_name', config('app.name', 'SaaSStater')) }}
                </h5>
                <p class="small text-muted mb-4" style="max-width: 380px;">
                    {{ config('settings.project_description', 'An astral purple glassmorphism SaaS interface.') }}
                </p>
            </div>
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <ul class="list-unstyled d-flex flex-column gap-2 small">
                    <li><a href="{{ route('auth.login') }}" class="text-decoration-none text-muted">Login</a></li>
                    <li><a href="{{ route('auth.register') }}" class="text-decoration-none text-muted">Get Started</a></li>
                    <li><a href="{{ route('admin.dashboard') }}" class="text-decoration-none text-danger">Admin Dashboard</a></li>
                </ul>
            </div>
        </div>
        <hr class="my-4 opacity-10" style="background-color: #ec4899;">
