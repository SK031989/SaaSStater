...
<div class="container-fluid py-4">
    <div class="max-w-4xl mx-auto">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 font-bold text-slate-900 dark:text-white mb-1">Edit Location</h1>
                <p class="text-sm text-slate-500 mb-0">Update address, contacts, and status for {{ $location->name }}.</p>
            </div>
