...
@section('title', 'Add New Extension')
...
<div class="container-fluid max-w-4xl">
    <div class="d-flex items-center gap-3 mb-4">
        ...
        <h1 class="h3 font-bold text-slate-900 dark:text-white mb-0">Add New Extension</h1>
    </div>
            ...
            <form action="{{ route('addons.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-4">
                        <i class="bi bi-check-lg me-1"></i> Save Extension
                    </button>
                </div>
            </form>
        </div>
