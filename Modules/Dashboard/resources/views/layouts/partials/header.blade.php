...
<header class="h-16 fixed top-0 right-0 left-0 md:left-64 sidebar-transition z-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800/80 flex items-center justify-between px-6 transition-colors duration-200">
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="relative">
            <button id="color-palette-btn" type="button" title="Select Accent Color"
            ...
            <div id="color-palette-dropdown"
                ...
                <div class="p-3">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-[10px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-wider">Choose Theme</span>
                        <span id="palette-color-count" class="text-[9px] font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/80 px-2 py-0.5 rounded-full">24 colors</span>
                    </div>
                    <div class="relative">
                        ...
                        <div id="palette-scroll-fade"
                            class="absolute bottom-0 left-0 right-1 h-9 bg-gradient-to-t from-white dark:from-slate-900 to-transparent pointer-events-none transition-opacity duration-200">
                        </div>
                    </div>
                </div>

                <!-- ▸ Footer -->
                <div class="px-4 py-3 flex items-center justify-between gap-2 border-t border-slate-100 dark:border-slate-850">
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="text-[10px] text-slate-400">Saved automatically</span>
                    </div>
                    <button id="palette-reset-btn" type="button"
                        class="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 text-[11px] font-semibold text-slate-500 dark:text-slate-400 bg-transparent hover:border-red-200 dark:hover:border-red-900/60 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 cursor-pointer transition-all duration-150 whitespace-nowrap">
            ...
            <div id="message-dropdown" class="dropdown-animate hidden-dropdown absolute right-0 mt-2 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl p-4 space-y-3">
                ...
                <div class="space-y-2">
                    <div class="flex items-start gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl cursor-pointer transition">
                        <img src="https://ui-avatars.com/api/?name=Sarah+Connor&background=c084fc&color=fff" class="accent-avatar w-9 h-9 rounded-xl">
                        <div class="flex-grow">
                    ...
                    <div class="flex items-start gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-xl cursor-pointer transition">
                        <img src="https://ui-avatars.com/api/?name=Marcus+Wright&background=f87171&color=fff" class="accent-avatar w-9 h-9 rounded-xl">
                        <div class="flex-grow">
